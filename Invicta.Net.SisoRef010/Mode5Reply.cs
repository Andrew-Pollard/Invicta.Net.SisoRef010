...
namespace Invicta.Net.SisoRef010 {
	...
	[Invicta.Net.SisoRef010.Attributes.SisoEnumerationAttribute(350, "Mode 5 Reply", 3)]
	public enum Mode5Reply : byte {
		[Invicta.Net.SisoRef010.Attributes.SisoEnumerantAttribute("b454543b-76cb-4cd5-bb73-b5ed16d3d1a4", Description="No Response")]
		NoResponse = 0,
		[Invicta.Net.SisoRef010.Attributes.SisoEnumerantAttribute("7c7b0cb3-d6ad-453a-8924-fc6d29c636a6", Description="Valid")]
		Valid = 1,
		[Invicta.Net.SisoRef010.Attributes.SisoEnumerantAttribute("d2a605ad-5011-4ec2-9e98-d62f37fa28ea", Description="Invalid")]
		Invalid = 2,
		[Invicta.Net.SisoRef010.Attributes.SisoEnumerantAttribute("f05d44d4-12d8-4462-9501-d6d36f03cff6", Description="Unable to Verify")]
		UnableToVerify = 3,
	}
}
